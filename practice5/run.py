...
# X = ...
# Задание 2
m = np.mean(X, axis=0) # вычисляет среднее вдоль определенной оси (если axis=None, осреднение происходит по всему массиву)
s = np.std(X, axis=0) # вычисляет стандартное отклонение вдоль определенной оси (если axis=None, по всему массиву)
X = (X - m) / s
